...
P_MicroMouseTemplate_T MicroMouseTemplate_P = {
  ...
  /* Computed Parameter: PulseGenerator9_Period
   * Referenced by: '<S4>/Pulse Generator9'
   */
  2.0,

  /* Computed Parameter: PulseGenerator9_Duty
   * Referenced by: '<S4>/Pulse Generator9'
   */
  1.0,
  ...
  /* Computed Parameter: PulseGenerator10_Period
   * Referenced by: '<S4>/Pulse Generator10'
   */
  2.0,

  /* Computed Parameter: PulseGenerator10_Duty
   * Referenced by: '<S4>/Pulse Generator10'
   */
  1.0,
